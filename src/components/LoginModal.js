...
export function showLoginModal() {
  return new Promise((resolve) => {
    ...
    const logoBlock = settings?.customLogo
      ...
      : `<div style="width:48px;height:48px;border-radius:12px;background:linear-gradient(135deg,#8b64fd,#7c3aed);display:inline-flex;align-items:center;justify-content:center;font-size:18px;font-weight:800;color:white;margin-bottom:12px;">P</div>`;
    ...
    root.innerHTML = `
      <div style="background:#fff;border-radius:20px;width:100%;max-width:400px;box-shadow:0 20px 25px rgba(0,0,0,0.3);overflow:hidden;">
        <div style="text-align:center;padding:28px 24px 16px;">
          ${logoBlock}
          <h2 style="font-size:16px;font-weight:700;color:#1f1f20;">PDP Task</h2>
        ...
        <div style="text-align:center;padding:12px;font-size:10px;color:#6b7280;border-top:1px solid #f3f4f6;">Phòng PDP FSC3DN © 2026</div>
      </div>
    `;
